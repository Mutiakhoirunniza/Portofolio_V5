...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/diahmutia/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@mutiakhrnniza",
    icon: Instagram,
    url: "https://www.instagram.com/mutiakhrnniza/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@diahmutiachoirunnisa",
    icon: Youtube,
    url: "https://www.youtube.com/@diahmutiachoirunnisa2310",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Mutiakhoirunniza",
    icon: Github,
    url: "https://github.com/Mutiakhoirunniza",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@pettystoryy?lang=id-ID",
    color: "black",
