...
import { TYPING_SPEED, ERASING_SPEED, PAUSE_DURATION, WORDS, TECH_STACK, SOCIAL_LINKS } from "../constants"
import { StatusBadge, MainTitle, TechStack, CTAButton, SocialLink } from "../components/Home/HomeComponents"
        ...
        <script type="application/ld+json">{`
          {
            ...
            "sameAs": [
              ...
              "https://www.instagram.com/mutia_khzr/"
            ]
          }
        `}</script>
      </Helmet>
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="h-8 flex items-center" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <span className="w-[3px] h-6 bg-indigo-500 ml-1 animate-blink"></span>
                  </div>

                  {/* Description */}
                  <p className="text-base md:text-lg text-slate-400 max-w-xl leading-relaxed font-light"
                    data-aos="fade-up"
                    data-aos-delay="1000">
